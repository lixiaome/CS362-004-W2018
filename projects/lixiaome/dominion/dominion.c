...
int run_adventurer(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int *temphand){
	int z = 0;
...
int run_council_room(int currentPlayer,struct gameState *state, int handPos){
	int i;	
	//+4 Cards
	for (i = 0; i < 4; i++)
	{
...
int run_feast(struct gameState *state, int currentPlayer, int *temphand, int choice1){
	int i;
	int x;
...
int run_mine(struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos){
	int j;
	int i;
